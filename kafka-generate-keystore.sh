...
echo "Welcome to the Kafka SSL keystore generator script."

trust_store_file=""
trust_store_private_key_file=""

  echo
  echo "OK, we'll get the trust store and associated private key."
  echo
  ...
  echo
  echo "$TRUSTSTORE_WORKING_DIRECTORY/$DEFAULT_TRUSTSTORE_FILENAME was found."
